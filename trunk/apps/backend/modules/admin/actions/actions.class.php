...
class adminActions extends sfActions
{
    public function executeBonusList()
    {
        ...
        $this->packageArrs = $this->doCalculatePackage($dateFrom);
        $this->totalDrb = $this->doCalculateDrb($dateFrom);
        $this->totalGrb = $this->doCalculateGrb($dateFrom);
        $this->totalGenerationBonus = $this->doCalculateGenerationBonus($dateFrom);
        $this->pipsRebate = $this->doCalculatePipsRebateBonus($dateFrom);
        $this->fundManagementBonus = $this->doCalculateFundManagementBonus($dateFrom);
        $this->specialBonus = $this->doCalculateSpecialBonus($dateFrom);
