...
$(function(){
    ...
    datagrid = $("#datagrid").r9jasonDataTable({
        ...
        "bServerSide": true,
        "bAutoWidth": false,
        "sAjaxSource": "<?php echo url_for('financeList/productPurchaseList') ?>",
        "sPaginationType": "full_numbers",
        "aaSorting": [
            [6,'desc']
        ],
        "aoColumns": [
            { "sName" : "purchase.history_id", "bVisible" : false},
            { "sName" : "dist.distributor_code",  "bSortable": true, "fnRender": function ( oObj ) {
                return "<a id='editLink' href='<?php echo url_for('finance/productPurchaseEdit?q=dsf453fsdfasf1sxfsdfs&purchaseId=') ?>/" + oObj.aData[0] + "'>" + oObj.aData[1] + "</a>";
            }},
            { "sName" : "dist.full_name",  "bSortable": true},
            { "sName" : "purchase.total_amount",  "bSortable": true},
...
<?php echo form_tag('finance/productPurchase', 'id=loginForm') ?>
<div style="padding: 10px; top: 30px; position: absolute; width: 1000px">
<div class="portlet">
    <div class="portlet-header">Product Purchase Listing</div>
