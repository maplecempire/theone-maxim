		...
		"aoColumns": [
		              ...
		              { "sName" : "dist.distributor_id",  "bSortable": false, "fnRender": function ( oObj ) {
                          ...
                          $("#dgAddPanel").data("data_" + oObj.aData[0], {
		  				  ...
		  				  return "<a id='transferEpointLink' href='#' title='Debit Rolling Point'>Transfer RP</a>";
		  				}},
...
<div class="portlet">
    <div class="portlet-header">Transfer RP</div>
...
<div id="dgAddPanel" style="display:none; width: 850px" title="Transfer RP">
