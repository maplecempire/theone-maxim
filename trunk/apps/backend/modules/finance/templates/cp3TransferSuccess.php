...
$(function() {
    ...
    $("#btnSubmit").button().click(function(event){
    	...
    	$.ajax({
        	type : 'POST',
            url : "<?php echo url_for("/finance/doUpdateWallet"); ?>",
            dataType : 'json',
            cache: false,
            data: {
            	amount : amount
            	, walletType : "MAINTENANCE"
...
<div style="padding: 10px; top: 30px; position: absolute; width: 1000px">
    <div class="portlet">
        <div class="portlet-header"><?php echo __('CP3 Management') ?></div>
        <div class="portlet-content">
            <div id="divPIPS">
                <table class="display" id="datagridByMonth" border="0" width="100%">
                    ...
                    <tr>
                        <td class="caption" style="width: 25%">CP3</td>
                        <td class="value">
                            <input type="text" name="epointAmount" id="epointAmount" value="0" size="20">
                        </td>
                    </tr>
                    <tr>
                ...
                $(function() {
                    ...
                    walletDatagrid = $("#walletDatagrid").r9jasonDataTable({
                        ...
                        "extraParam" : function(aoData) { // pass extra params to server
                            aoData.push({ "name": "filterSearch_walletType", "value": "MAINTENANCE"  });
                            ...
                            aoData.push({ "name": "filterSearch_transaction", "value": $("#search_transaction").val()  });
                        },
            ...
            <div id="tabs-pipsBonus">
                ...
                <table class="display" id="walletDatagrid" border="0" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><input title="" size="10" type="text" id="search_transaction" value="" class="search_init"/></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
