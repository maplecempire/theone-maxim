...
$(function(){
    ...
    $("#btnExport").button({
        ...
        window.open("<?php echo url_for("finance/cp2WithdrawalListInDetail")?>?filterUsername=" + $("#search_username").val() + "&filterLeader=" + $("#txtLeaderId").val() + "&statusCode=" + $("#search_combo_statusCode").val() + "&dateFrom=" + $("#txtDateFrom").val() + "&dateTo=" + $("#txtDateTo").val());
    });
}); // end $(function())
