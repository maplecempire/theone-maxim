...
$(function(){
    ...
    datagrid = $("#datagrid").r9jasonDataTable({
        ...
        "extraParam" : function(aoData) { // pass extra params to server
            ...
            aoData.push({ "name": "filterTransaction", "value": $("#cboTransaction").val()  });
        },
        ...
        "bServerSide": true,
        "bAutoWidth": false,
        "sAjaxSource": "<?php echo url_for('reportList/epointTransferList') ?>",
        "sPaginationType": "full_numbers",
        "aaSorting": [[1,'desc']],
        "aoColumns": [
            { "sName" : "ledger.account_id", "bVisible" : false},
...
<div class="portlet">
    <div class="portlet-header">e-Point Transfer Report</div>
				...
				<tr>
					...
					<table class="display" id="datagrid" border="0" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <select id="cboTransaction">
                                    <option value="">All</option>
                                    <option value="<?php echo Globals::ACCOUNT_LEDGER_ACTION_TRANSFER_FROM?>"><?php echo Globals::ACCOUNT_LEDGER_ACTION_TRANSFER_FROM?></option>
                                    <option value="<?php echo Globals::ACCOUNT_LEDGER_ACTION_TRANSFER_TO?>"><?php echo Globals::ACCOUNT_LEDGER_ACTION_TRANSFER_TO?></option>
                                </select>
                            </td>
                            <td></td>
                        </tr>
