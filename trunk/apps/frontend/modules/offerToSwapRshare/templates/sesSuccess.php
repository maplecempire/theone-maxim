        ...
        <table cellpadding="3" cellspacing="5">
            ...
            <tr>
                <td class="tbl_sprt_bottom">
                    ...
                    if ($culture == "cn") {
                    ?>
                        <span class="txt_title">RT转换优惠 </span>
                    <?php
                    } else if ($culture == "kr") {
                    ?>
                ...
                <td>
                    ...
                    <ol>
                        ...
                        ?>
                            ...
                            <li style="padding-bottom: 10px;">本人同意，于该豁免申请通过的条件下，将投资本金(等同于MT4交易账户余额) {USD$ <input type="text" readonly="readonly" style="text-align: right;" id="txtMt4Balance" value="<?php echo number_format($mt4Balance,2);?>">} <input type="hidden" id="txtRemainingRoiAmount" style="text-align: right;" readonly="readonly" value="<?php echo number_format($remainingRoiAmount,2);?>"> 全部用于转换成RT。</li>
                            <li style="padding-bottom: 10px; display: none; ">本人同意，于该豁免申请通过的条件下，将CP2账户{USD$ <input type="text" id="convertedCp2" name="convertedCp2" style="text-align: right;" value=>} 或/和CP3账户{USD$ <input type="text" id="convertedCp3" style="text-align: right;" name="convertedCp3" value="0">} 转换成RT。</li>
                        <?php
                        } else if ($culture == "kr") {
                        ?>
