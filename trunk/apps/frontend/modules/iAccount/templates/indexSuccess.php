...
<tr>
    <td>
        <table>
            <tr>
                <td align="left">
                    <a href="https://apply.i-account.cc/online_form/account/maxim/iac.php" target="_blank"><img src="http://partner.lidyarich.com/af300/accounts/default1/banners/7f6fb8e1.png" alt="" title="" width="270" height="112" /></a><img style="border:0" src="http://partner.lidyarich.com/af300/scripts/imp.php?a_aid=53cf8e44ce6ed&amp;a_bid=7f6fb8e1" width="1" height="1" alt="" />
                    <br>
                </td>
            </tr>
            <tr>
                <td>
                    <a href="https://apply.i-account.cc/online_form/account/maxim/iac.php" target="_blank">
                        <?php if ($culture == "cn") { ?>
...
<br><br><strong>Knowing that you have quick and easy access to your money is key to feeling secure. Make personal international financial transactions, while at the same time protecting your financial privacy!</strong>
            ...
            <tr>
                <td>
                    ...
                    <br>
                    <br>
                    <a href="https://apply.i-account.cc/online_form/account/maxim/iac.php" target="_blank"><?php if ($culture == "cn") { ?>
