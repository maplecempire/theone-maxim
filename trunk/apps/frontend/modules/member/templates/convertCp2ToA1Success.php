...
<table cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="tbl_sprt_bottom"><span class="txt_title"><?php echo __('Convert CP2 To A1') ?></span></td>
    </tr>
    <tr>
        <td><br>
    ...
    <tr>
        <td>
            <form action="<?php echo url_for("/member/convertCp2ToA1") ?>" id="ecreditForm" name="ecreditForm" method="post">
            <table cellspacing="0" cellpadding="0" class="tbl_form">
                ...
                <tr>
                    ...
                    <th colspan="2"><?php echo __('Convert CP2 To A1') ?></th>
