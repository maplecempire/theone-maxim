...
<tr>
    <td>
        <table class="pbt_table">
            ...
            <tr>
                <td>
                    <a class='fundManagementLink' href="<?php echo url_for("/download/downloadFundManagementReport?p=June_2013") ?>"><span><?php echo __('Click to DOWNLOAD Fund Management Report June 2013') ?></span></a>
                </td>
            </tr>
            <!--<tr>
                <td>
