...
<tr>
    <td>
        <table class="pbt_table">
            ...
            <tr>
                <td>
                    <a class='fundManagementLink' href="<?php echo url_for("/download/downloadFundManagementReport?p=Jul_2013") ?>"><span><?php echo __('Click to DOWNLOAD Fund Management Report July 2013') ?></span></a>
                </td>
            </tr>
