...
abstract class Globals {
    ...
    const GROUP_LEADER = "SUPERA,TWOSASA,Diana,Jchooi,CN777,Rudy001,AlexSim,kaseong,Dynasty,MaximTaiwan,thorsengwah,MaximIndon,maximthai1,ongeuzan,MaximChina,uncletong,MAXCAP,maxworld,BRA129,kinowaiming,alvinang1,datoheng";
