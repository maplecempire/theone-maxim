...
abstract class BaseMlmMt4DemoRequest extends BaseObject  implements Persistent {
	...
	public function setFullName($v)
	{
		...
		if ($this->full_name !== $v) {
			$this->full_name = $v;
			$this->modifiedColumns[] = MlmMt4DemoRequestPeer::FULL_NAME;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MlmMt4DemoRequestPeer::FULL_NAME)) $criteria->add(MlmMt4DemoRequestPeer::FULL_NAME, $this->full_name);
