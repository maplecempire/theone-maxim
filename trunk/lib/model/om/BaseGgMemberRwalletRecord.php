...
abstract class BaseGgMemberRwalletRecord extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = GgMemberRwalletRecordPeer::ID;
		}
	...
	public function setUid($v)
	{
		...
		if ($this->uid !== $v || $v === '0') {
			$this->uid = $v;
			$this->modifiedColumns[] = GgMemberRwalletRecordPeer::UID;
		}
	...
	public function setAid($v)
	{
		...
		if ($this->aid !== $v || $v === '0') {
			$this->aid = $v;
			$this->modifiedColumns[] = GgMemberRwalletRecordPeer::AID;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = GgMemberRwalletRecordPeer::TYPE;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v || $v === 0) {
			$this->amount = $v;
			$this->modifiedColumns[] = GgMemberRwalletRecordPeer::AMOUNT;
		}
	...
	public function setBal($v)
	{
		...
		if ($this->bal !== $v || $v === 0) {
			$this->bal = $v;
			$this->modifiedColumns[] = GgMemberRwalletRecordPeer::BAL;
		}
	...
	public function setDescr($v)
	{
		...
		if ($this->descr !== $v) {
			$this->descr = $v;
			$this->modifiedColumns[] = GgMemberRwalletRecordPeer::DESCR;
		}
	...
	public function setCdate($v)
	{
		...
		if ($this->cdate !== $ts) {
			$this->cdate = $ts;
			$this->modifiedColumns[] = GgMemberRwalletRecordPeer::CDATE;
		}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			GgMemberRwalletRecordPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = GgMemberRwalletRecordPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += GgMemberRwalletRecordPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = GgMemberRwalletRecordPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = GgMemberRwalletRecordPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = GgMemberRwalletRecordPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getUid(),
			$keys[2] => $this->getAid(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GgMemberRwalletRecordPeer::DESCR)) $criteria->add(GgMemberRwalletRecordPeer::DESCR, $this->descr);
		if ($this->isColumnModified(GgMemberRwalletRecordPeer::CDATE)) $criteria->add(GgMemberRwalletRecordPeer::CDATE, $this->cdate);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(GgMemberRwalletRecordPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new GgMemberRwalletRecordPeer();
		}
		return self::$peer;
	}
