...
abstract class BaseGgMemberRtwalletRecord extends BaseObject  implements Persistent {
	...
	public function setActionType($v)
	{
		...
		if ($this->action_type !== $v) {
			$this->action_type = $v;
			$this->modifiedColumns[] = GgMemberRtwalletRecordPeer::ACTION_TYPE;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GgMemberRtwalletRecordPeer::ACTION_TYPE)) $criteria->add(GgMemberRtwalletRecordPeer::ACTION_TYPE, $this->action_type);
