...
abstract class BaseMlmDistributorPeer {
	...
	const IS_DEMO_ACCOUNT = 'mlm_distributor.IS_DEMO_ACCOUNT';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MlmDistributorPeer::IS_DEMO_ACCOUNT);
