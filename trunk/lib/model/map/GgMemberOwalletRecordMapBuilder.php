...
class GgMemberOwalletRecordMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.GgMemberOwalletRecordMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('gg_member_owallet_record');
		$tMap->setPhpName('GgMemberOwalletRecord');
