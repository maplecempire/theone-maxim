...
class GgMemberEswalletRecordMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.GgMemberEswalletRecordMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('gg_member_eswallet_record');
		$tMap->setPhpName('GgMemberEswalletRecord');
