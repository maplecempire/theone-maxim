...
class MlmFileDownloadMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.MlmFileDownloadMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mlm_file_download');
		$tMap->setPhpName('MlmFileDownload');
