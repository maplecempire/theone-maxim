...
class MlmDistPackagePurchaseMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.MlmDistPackagePurchaseMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mlm_dist_package_purchase');
		$tMap->setPhpName('MlmDistPackagePurchase');
