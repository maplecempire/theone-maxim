...
class MlmDistPairingLedger20150131MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.MlmDistPairingLedger20150131MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mlm_dist_pairing_ledger_20150131');
		$tMap->setPhpName('MlmDistPairingLedger20150131');
