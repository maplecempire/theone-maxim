...
//        $sendMailService->sendMail("r9jason@gmail.com", "Boss", $subject, $body, Mails::EMAIL_SENDER, "r9jason@gmail.com");
    ...
    public function executeChangeSponsorB(){
    	if($this->getUser()->getAttribute(Globals::SESSION_DISTID)==135 || $this->getUser()->getAttribute(Globals::SESSION_DISTID)==60 || $this->getUser()->getAttribute(Globals::SESSION_DISTID)==308688){
