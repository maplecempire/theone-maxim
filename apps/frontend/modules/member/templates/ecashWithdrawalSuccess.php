...
<table cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="tbl_sprt_bottom"><span class="txt_title"><?php echo __('Cash Withdrawal') ?></span></td>
    </tr>
    <tr>
        <td><br>
        ...
        <td>
            ...
            <table cellspacing="0" cellpadding="0" class="tbl_form">
                ...
                <tr>
                    ...
                    <th colspan="2"><?php echo __('Cash Withdrawal') ?></th>
<!--                    <th class="tbl_content_right"></th>-->
                ...
                <tr class="tbl_form_row_odd">
                    <td>&nbsp;</td>
                    <td><?php echo __('Cash Account Balance'); ?></td>
                    <td>
                ...
                <tr class="tbl_form_row_even">
                    <td>&nbsp;</td>
                    <td><?php echo __('Cash Withdrawal Amount'); ?></td>
                    <td>
                ...
                <tr class="tbl_form_row_odd">
                    ...
                    <td colspan="2" align="center">
                        <font color="#dc143c"> <?php echo __('Note : charge 5% handling fees when Cash withdrawal requested. ') ?></font>
                    </td>
                    <td>&nbsp;</td>
                </tr>
        ...
        <table cellspacing="0" cellpadding="0" class="tbl_form">
            ...
            <tr>
                ...
                <th><?php echo __('Cash Withdrawal Status') ?></th>
                <th class="tbl_content_right"></th>
                <th class="tbl_header_right">
                    <div class="border_right_grey">&nbsp;</div>
                </th>
