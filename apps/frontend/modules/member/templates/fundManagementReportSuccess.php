...
<tr>
    <td>
        <table class="pbt_table">
            ...
            <tr>
                <td>
                    <a class='fundManagementLink' href="<?php echo url_for("/download/downloadFundManagementReport?p=Jan_2014") ?>"><span><?php echo __('Click to DOWNLOAD Fund Management Report Dec 2013') ?></span></a>
                </td>
            </tr>
