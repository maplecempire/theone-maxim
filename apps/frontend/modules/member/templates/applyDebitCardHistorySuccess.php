...
<table cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="tbl_sprt_bottom"><span class="txt_title"><?php echo __('Apply Maxim Trader VISA Debit Card History') ?></span></td>
    </tr>
    <tr>
        <td><br></td>
    </tr>
        ...
        <td>
            <table cellspacing="0" cellpadding="0" class="tbl_form">
                ...
                <tr>
                    ...
                    <th colspan="2"><?php echo __('Apply Maxim Trader VISA Debit Card History') ?></th>
