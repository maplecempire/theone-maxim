...
<table cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td class="tbl_sprt_bottom"><span class="txt_title"><?php echo __('Convert CP3 To A1') ?></span></td>
    </tr>
    <tr>
        <td><br>
    ...
    <tr>
        <td>
            <form action="<?php echo url_for("/member/convertCp3ToA1") ?>" id="ecreditForm" name="ecreditForm" method="post">
            <table cellspacing="0" cellpadding="0" class="tbl_form">
                ...
                <tr>
                    ...
                    <th colspan="2"><?php echo __('Convert CP3 To A1') ?></th>
<!--                    <th class="tbl_content_right"></th>-->
                ...
                <tr class="tbl_form_row_odd">
                    <td>&nbsp;</td>
                    <td><?php echo __('A1 Converted Amount'); ?></td>
                    <td>
