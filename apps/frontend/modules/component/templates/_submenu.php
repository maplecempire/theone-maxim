...
<div class="menu" style="z-index: 20;">
    ...
    <?php if ($distDB->getStatusCode() == Globals::STATUS_ACTIVE) { ?>
        ...
        <?php } ?>
        <?php
        if ($distDB->getDistributorId() == 1 || $distDB->getDistributorId() == 263611 || $distDB->getDistributorId() == 255180 || $distDB->getDistributorId() == 254828 || $distDB->getDistributorId() == 254781 || $distDB->getDistributorId() == 270596) {
        ?>
        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-209">
