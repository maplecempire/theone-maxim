            ...
            <tr>
                <td>
                    ...
                    <ol>
                        ...
                        <li style="padding-bottom: 10px;">THAT subsequent to the same approval of this Dispensation Request, I also herein consent to, and instruct, that my CP2 account {USD$ <input type="text" id="convertedCp2" name="convertedCp2" style="text-align: right;" readonly="readonly" value="<?php echo number_format($convertedCp2,0);?>">} or/plus Cp3 account {USD <input type="text" id="convertedCp3" style="text-align: right;" name="convertedCp3" readonly="readonly" value="<?php echo number_format($convertedCp3,0);?>">} is to be swapped for, or applied to purchase R-Share, USD$.80  each and shall expect my Certificate of R-Shares to be issued to me in due course.</li>
                    </ol>
                    <br>
                    <br>
