...
<form action="/may2013_shanghai_fair_wheel_of_fortune/doSubmit" id="registerForm" method="post">
...
<tr>
    <td rowspan="3">&nbsp;</td>
    <td class="tbl_sprt_bottom"><span class="txt_title"><?php echo __('Wheel of Fortune Registration') ?></span></td>
    <td rowspan="3">&nbsp;</td>
</tr>
<tr>
    <td><br>
...
<table cellspacing="0" cellpadding="0" class="tbl_form">
    ...
    <tr class="tbl_form_row_even">
        <td>&nbsp;</td>
        <td><?php echo __('Referrer (if any)') ?></td>
        <td>
            <input type="text" class="inputbox" id="referrer" name="referrer">
        </td>
        <td>&nbsp;</td>
    </tr>
    ...
    <tr class="tbl_form_row_odd">
        <td>&nbsp;</td>
        <td><?php echo __('WoF Lucky Draw Winnings') ?></td>
        <td>
            <input type="text" class="inputbox" id="luckyDraw" name="luckyDraw">
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr class="tbl_form_row_even">
        <td>&nbsp;</td>
        <td><?php echo __('Serial No.') ?></td>
        <td>
            <input type="text" class="inputbox" id="serialNo" name="serialNo">
        </td>
        <td>&nbsp;</td>
    </tr>
