 ...
 *
 * @package    sf_sandbox
 * @subpackage royaleMall
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 2692 2006-11-15 21:03:55Z fabien $
 */
class royaleMallActions extends sfActions
{
  /**
  ...
  public function executeTestMd5()
    {
        ...
        var_dump(md5("q=checkout&a=ROYALEMALL".date("Ymd")));
        var_dump(md5("q=enquirybalance&a=ROYALEMALL".date("Ymd")));
        exit();
    }
    ...
    public function executeIndex()
    {
        ...
        $signatureString = "q=".$this->getRequestParameter('q')."&a=ROYALEMALL";
    ...
    public function executeCheckout()
    {
        ...
        if (!$apiTransaction) {
            ...
            if ($rtBalance < $amount) {
                ...
                $mlm_account_ledger->setTransactionType("ROYALEMALL");
    ...
    public function executeDoLogin()
    {
        ...
        if ($username == '' || $password == '') {
            ...
            return $this->redirect('royaleMall/index?q='.$q."&a=".$a."&rid=".$rid);
        }
        ...
        if (!$resp->is_valid) {
            ...
            return $this->redirect('royaleMall/index');
        }*/
        ...
        if ($existUser) {
            ...
            $appLoginLog->setRemark("ROYALEMALL");
            ...
            $transactionToken = $apiTransaction->getTransactionId()."ROYALEMALL";
