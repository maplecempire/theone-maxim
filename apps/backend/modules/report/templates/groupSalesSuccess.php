Please explain what is group sales report
...
$(function(){
    ...
    datagrid = $("#datagrid").r9jasonDataTable({
        ...
        "bServerSide": true,
        "bAutoWidth": false,
        "sAjaxSource": "<?php /*echo url_for('reportList/groupSalesList') */?>",
        "sPaginationType": "full_numbers",
        "aaSorting": [[1,'desc']],
        "aoColumns": [
            { "sName" : "ledger.commission_id", "bVisible" : false},
...
<div class="portlet">
    <div class="portlet-header">Group Sales Report</div>
