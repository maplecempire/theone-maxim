...
abstract class BaseGgMemberTwalletRecord extends BaseObject  implements Persistent {
	...
	public function setActionType($v)
	{
		...
		if ($this->action_type !== $v) {
			$this->action_type = $v;
			$this->modifiedColumns[] = GgMemberTwalletRecordPeer::ACTION_TYPE;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GgMemberTwalletRecordPeer::ACTION_TYPE)) $criteria->add(GgMemberTwalletRecordPeer::ACTION_TYPE, $this->action_type);
