...
abstract class BaseMlmPlacement extends BaseObject  implements Persistent {
	...
	public function setPlacementId($v)
	{
		...
		if ($this->placement_id !== $v) {
			$this->placement_id = $v;
			$this->modifiedColumns[] = MlmPlacementPeer::PLACEMENT_ID;
		}
	...
	public function setDistId($v)
	{
		...
		if ($this->dist_id !== $v || $v === 0) {
			$this->dist_id = $v;
			$this->modifiedColumns[] = MlmPlacementPeer::DIST_ID;
		}
	...
	public function setDistCode($v)
	{
		...
		if ($this->dist_code !== $v) {
			$this->dist_code = $v;
			$this->modifiedColumns[] = MlmPlacementPeer::DIST_CODE;
		}
	...
	public function setUplineDistId($v)
	{
		...
		if ($this->upline_dist_id !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = MlmPlacementPeer::UPLINE_DIST_ID;
		}
	...
	public function setUplineDistCode($v)
	{
		...
		if ($this->upline_dist_code !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = MlmPlacementPeer::UPLINE_DIST_CODE;
		}
	...
	public function setPlacePosition($v)
	{
		...
		if ($this->place_position !== $v) {
			...
			$this->modifiedColumns[] = MlmPlacementPeer::PLACE_POSITION;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = MlmPlacementPeer::CREATED_BY;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ($this->created_on !== $ts) {
			$this->created_on = $ts;
			$this->modifiedColumns[] = MlmPlacementPeer::CREATED_ON;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = MlmPlacementPeer::UPDATED_BY;
		}
	...
	public function setUpdatedOn($v)
	{
		...
		if ($this->updated_on !== $ts) {
			$this->updated_on = $ts;
			$this->modifiedColumns[] = MlmPlacementPeer::UPDATED_ON;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating MlmPlacement object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			MlmPlacementPeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(MlmPlacementPeer::CREATED_ON))
    {
      $this->setCreatedOn(time());
    }

    if ($this->isModified() && !$this->isColumnModified(MlmPlacementPeer::UPDATED_ON))
    {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = MlmPlacementPeer::doInsert($this, $con);
					$affectedRows += 1; 
					...
					$affectedRows += MlmPlacementPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = MlmPlacementPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = MlmPlacementPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = MlmPlacementPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MlmPlacementPeer::PLACEMENT_ID)) $criteria->add(MlmPlacementPeer::PLACEMENT_ID, $this->placement_id);
		if ($this->isColumnModified(MlmPlacementPeer::DIST_ID)) $criteria->add(MlmPlacementPeer::DIST_ID, $this->dist_id);
		if ($this->isColumnModified(MlmPlacementPeer::DIST_CODE)) $criteria->add(MlmPlacementPeer::DIST_CODE, $this->dist_code);
		if ($this->isColumnModified(MlmPlacementPeer::UPLINE_DIST_ID)) $criteria->add(MlmPlacementPeer::UPLINE_DIST_ID, $this->upline_dist_id);
		if ($this->isColumnModified(MlmPlacementPeer::UPLINE_DIST_CODE)) $criteria->add(MlmPlacementPeer::UPLINE_DIST_CODE, $this->upline_dist_code);
		if ($this->isColumnModified(MlmPlacementPeer::PLACE_POSITION)) $criteria->add(MlmPlacementPeer::PLACE_POSITION, $this->place_position);
		if ($this->isColumnModified(MlmPlacementPeer::CREATED_BY)) $criteria->add(MlmPlacementPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(MlmPlacementPeer::CREATED_ON)) $criteria->add(MlmPlacementPeer::CREATED_ON, $this->created_on);
		if ($this->isColumnModified(MlmPlacementPeer::UPDATED_BY)) $criteria->add(MlmPlacementPeer::UPDATED_BY, $this->updated_by);
		if ($this->isColumnModified(MlmPlacementPeer::UPDATED_ON)) $criteria->add(MlmPlacementPeer::UPDATED_ON, $this->updated_on);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(MlmPlacementPeer::PLACEMENT_ID, $this->placement_id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new MlmPlacementPeer();
		}
		return self::$peer;
	}
