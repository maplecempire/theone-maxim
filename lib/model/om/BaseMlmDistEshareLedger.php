...
abstract class BaseMlmDistEshareLedger extends BaseObject  implements Persistent {
	...
	public function setEshareId($v)
	{
		...
		if ($this->eshare_id !== $v) {
			$this->eshare_id = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::ESHARE_ID;
		}
	...
	public function setDistId($v)
	{
		...
		if ($this->dist_id !== $v) {
			$this->dist_id = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::DIST_ID;
		}
	...
	public function setBuyPrice($v)
	{
		...
		if ($this->buy_price !== $v || $v === 0) {
			$this->buy_price = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::BUY_PRICE;
		}
	...
	public function setCredit($v)
	{
		...
		if ($this->credit !== $v) {
			$this->credit = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::CREDIT;
		}
	...
	public function setSellPrice($v)
	{
		...
		if ($this->sell_price !== $v || $v === 0) {
			$this->sell_price = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::SELL_PRICE;
		}
	...
	public function setDebit($v)
	{
		...
		if ($this->debit !== $v) {
			$this->debit = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::DEBIT;
		}
	...
	public function setProfit($v)
	{
		...
		if ($this->profit !== $v || $v === 0) {
			$this->profit = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::PROFIT;
		}
	...
	public function setShareBalance($v)
	{
		...
		if ($this->share_balance !== $v) {
			...
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::SHARE_BALANCE;
		}
	...
	public function setRemark($v)
	{
		...
		if ($this->remark !== $v) {
			$this->remark = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::REMARK;
		}
	...
	public function setValidSellDate($v)
	{
		...
		if ($this->valid_sell_date !== $ts) {
			...
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::VALID_SELL_DATE;
		}
	...
	public function setSellDate($v)
	{
		...
		if ($this->sell_date !== $ts) {
			$this->sell_date = $ts;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::SELL_DATE;
		}
	...
	public function setStatusCode($v)
	{
		...
		if ($this->status_code !== $v) {
			$this->status_code = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::STATUS_CODE;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::CREATED_BY;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ($this->created_on !== $ts) {
			$this->created_on = $ts;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::CREATED_ON;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::UPDATED_BY;
		}
	...
	public function setUpdatedOn($v)
	{
		...
		if ($this->updated_on !== $ts) {
			$this->updated_on = $ts;
			$this->modifiedColumns[] = MlmDistEshareLedgerPeer::UPDATED_ON;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating MlmDistEshareLedger object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			MlmDistEshareLedgerPeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(MlmDistEshareLedgerPeer::CREATED_ON))
    {
      $this->setCreatedOn(time());
    }

    if ($this->isModified() && !$this->isColumnModified(MlmDistEshareLedgerPeer::UPDATED_ON))
    {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = MlmDistEshareLedgerPeer::doInsert($this, $con);
					$affectedRows += 1; 
					...
					$affectedRows += MlmDistEshareLedgerPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = MlmDistEshareLedgerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = MlmDistEshareLedgerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = MlmDistEshareLedgerPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::ESHARE_ID)) $criteria->add(MlmDistEshareLedgerPeer::ESHARE_ID, $this->eshare_id);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::DIST_ID)) $criteria->add(MlmDistEshareLedgerPeer::DIST_ID, $this->dist_id);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::BUY_PRICE)) $criteria->add(MlmDistEshareLedgerPeer::BUY_PRICE, $this->buy_price);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::CREDIT)) $criteria->add(MlmDistEshareLedgerPeer::CREDIT, $this->credit);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::SELL_PRICE)) $criteria->add(MlmDistEshareLedgerPeer::SELL_PRICE, $this->sell_price);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::DEBIT)) $criteria->add(MlmDistEshareLedgerPeer::DEBIT, $this->debit);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::PROFIT)) $criteria->add(MlmDistEshareLedgerPeer::PROFIT, $this->profit);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::SHARE_BALANCE)) $criteria->add(MlmDistEshareLedgerPeer::SHARE_BALANCE, $this->share_balance);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::REMARK)) $criteria->add(MlmDistEshareLedgerPeer::REMARK, $this->remark);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::VALID_SELL_DATE)) $criteria->add(MlmDistEshareLedgerPeer::VALID_SELL_DATE, $this->valid_sell_date);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::SELL_DATE)) $criteria->add(MlmDistEshareLedgerPeer::SELL_DATE, $this->sell_date);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::STATUS_CODE)) $criteria->add(MlmDistEshareLedgerPeer::STATUS_CODE, $this->status_code);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::CREATED_BY)) $criteria->add(MlmDistEshareLedgerPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::CREATED_ON)) $criteria->add(MlmDistEshareLedgerPeer::CREATED_ON, $this->created_on);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::UPDATED_BY)) $criteria->add(MlmDistEshareLedgerPeer::UPDATED_BY, $this->updated_by);
		if ($this->isColumnModified(MlmDistEshareLedgerPeer::UPDATED_ON)) $criteria->add(MlmDistEshareLedgerPeer::UPDATED_ON, $this->updated_on);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(MlmDistEshareLedgerPeer::ESHARE_ID, $this->eshare_id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new MlmDistEshareLedgerPeer();
		}
		return self::$peer;
	}
