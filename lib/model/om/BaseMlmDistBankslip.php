...
abstract class BaseMlmDistBankslip extends BaseObject  implements Persistent {
	...
	public function setBankslipId($v)
	{
		...
		if ($this->bankslip_id !== $v) {
			$this->bankslip_id = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::BANKSLIP_ID;
		}
	...
	public function setDistId($v)
	{
		...
		if ($this->dist_id !== $v) {
			$this->dist_id = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::DIST_ID;
		}
	...
	public function setRankId($v)
	{
		...
		if ($this->rank_id !== $v) {
			$this->rank_id = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::RANK_ID;
		}
	...
	public function setRankCode($v)
	{
		...
		if ($this->rank_code !== $v) {
			$this->rank_code = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::RANK_CODE;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v || $v === 0) {
			$this->amount = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::AMOUNT;
		}
	...
	public function setTransactionType($v)
	{
		...
		if ($this->transaction_type !== $v) {
			...
			$this->modifiedColumns[] = MlmDistBankslipPeer::TRANSACTION_TYPE;
		}
	...
	public function setImageSrc($v)
	{
		...
		if ($this->image_src !== $v) {
			$this->image_src = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::IMAGE_SRC;
		}
	...
	public function setStatusCode($v)
	{
		...
		if ($this->status_code !== $v) {
			$this->status_code = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::STATUS_CODE;
		}
	...
	public function setRemarks($v)
	{
		...
		if ($this->remarks !== $v) {
			$this->remarks = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::REMARKS;
		}
	...
	public function setApproveRejectDatetime($v)
	{
		...
		if ($this->approve_reject_datetime !== $ts) {
			...
			$this->modifiedColumns[] = MlmDistBankslipPeer::APPROVE_REJECT_DATETIME;
		}
	...
	public function setApprovedByUserid($v)
	{
		...
		if ($this->approved_by_userid !== $v) {
			...
			$this->modifiedColumns[] = MlmDistBankslipPeer::APPROVED_BY_USERID;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::CREATED_BY;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ($this->created_on !== $ts) {
			$this->created_on = $ts;
			$this->modifiedColumns[] = MlmDistBankslipPeer::CREATED_ON;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = MlmDistBankslipPeer::UPDATED_BY;
		}
	...
	public function setUpdatedOn($v)
	{
		...
		if ($this->updated_on !== $ts) {
			$this->updated_on = $ts;
			$this->modifiedColumns[] = MlmDistBankslipPeer::UPDATED_ON;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating MlmDistBankslip object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			MlmDistBankslipPeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(MlmDistBankslipPeer::CREATED_ON))
    {
      $this->setCreatedOn(time());
    }

    if ($this->isModified() && !$this->isColumnModified(MlmDistBankslipPeer::UPDATED_ON))
    {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = MlmDistBankslipPeer::doInsert($this, $con);
					$affectedRows += 1; 
					...
					$affectedRows += MlmDistBankslipPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = MlmDistBankslipPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = MlmDistBankslipPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = MlmDistBankslipPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MlmDistBankslipPeer::BANKSLIP_ID)) $criteria->add(MlmDistBankslipPeer::BANKSLIP_ID, $this->bankslip_id);
		if ($this->isColumnModified(MlmDistBankslipPeer::DIST_ID)) $criteria->add(MlmDistBankslipPeer::DIST_ID, $this->dist_id);
		if ($this->isColumnModified(MlmDistBankslipPeer::RANK_ID)) $criteria->add(MlmDistBankslipPeer::RANK_ID, $this->rank_id);
		if ($this->isColumnModified(MlmDistBankslipPeer::RANK_CODE)) $criteria->add(MlmDistBankslipPeer::RANK_CODE, $this->rank_code);
		if ($this->isColumnModified(MlmDistBankslipPeer::AMOUNT)) $criteria->add(MlmDistBankslipPeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(MlmDistBankslipPeer::TRANSACTION_TYPE)) $criteria->add(MlmDistBankslipPeer::TRANSACTION_TYPE, $this->transaction_type);
		if ($this->isColumnModified(MlmDistBankslipPeer::IMAGE_SRC)) $criteria->add(MlmDistBankslipPeer::IMAGE_SRC, $this->image_src);
		if ($this->isColumnModified(MlmDistBankslipPeer::STATUS_CODE)) $criteria->add(MlmDistBankslipPeer::STATUS_CODE, $this->status_code);
		if ($this->isColumnModified(MlmDistBankslipPeer::REMARKS)) $criteria->add(MlmDistBankslipPeer::REMARKS, $this->remarks);
		if ($this->isColumnModified(MlmDistBankslipPeer::APPROVE_REJECT_DATETIME)) $criteria->add(MlmDistBankslipPeer::APPROVE_REJECT_DATETIME, $this->approve_reject_datetime);
		if ($this->isColumnModified(MlmDistBankslipPeer::APPROVED_BY_USERID)) $criteria->add(MlmDistBankslipPeer::APPROVED_BY_USERID, $this->approved_by_userid);
		if ($this->isColumnModified(MlmDistBankslipPeer::CREATED_BY)) $criteria->add(MlmDistBankslipPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(MlmDistBankslipPeer::CREATED_ON)) $criteria->add(MlmDistBankslipPeer::CREATED_ON, $this->created_on);
		if ($this->isColumnModified(MlmDistBankslipPeer::UPDATED_BY)) $criteria->add(MlmDistBankslipPeer::UPDATED_BY, $this->updated_by);
		if ($this->isColumnModified(MlmDistBankslipPeer::UPDATED_ON)) $criteria->add(MlmDistBankslipPeer::UPDATED_ON, $this->updated_on);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(MlmDistBankslipPeer::BANKSLIP_ID, $this->bankslip_id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new MlmDistBankslipPeer();
		}
		return self::$peer;
	}
