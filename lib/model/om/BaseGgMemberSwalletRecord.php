...
abstract class BaseGgMemberSwalletRecord extends BaseObject  implements Persistent {
	...
	public function setActionType($v)
	{
		...
		if ($this->action_type !== $v) {
			$this->action_type = $v;
			$this->modifiedColumns[] = GgMemberSwalletRecordPeer::ACTION_TYPE;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GgMemberSwalletRecordPeer::ACTION_TYPE)) $criteria->add(GgMemberSwalletRecordPeer::ACTION_TYPE, $this->action_type);
