...
class GgMemberRpfwalletRecordMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.GgMemberRpfwalletRecordMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('gg_member_rpfwallet_record');
		$tMap->setPhpName('GgMemberRpfwalletRecord');
