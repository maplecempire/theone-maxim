...
class GgMemberPwalletRecordMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.GgMemberPwalletRecordMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('gg_member_pwallet_record');
		$tMap->setPhpName('GgMemberPwalletRecord');
