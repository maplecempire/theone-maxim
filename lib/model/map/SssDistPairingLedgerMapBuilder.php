...
class SssDistPairingLedgerMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.SssDistPairingLedgerMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('sss_dist_pairing_ledger');
		$tMap->setPhpName('SssDistPairingLedger');
