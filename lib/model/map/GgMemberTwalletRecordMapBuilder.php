...
class GgMemberTwalletRecordMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.GgMemberTwalletRecordMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('gg_member_twallet_record');
		$tMap->setPhpName('GgMemberTwalletRecord');
