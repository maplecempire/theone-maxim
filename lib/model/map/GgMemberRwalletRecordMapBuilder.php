...
class GgMemberRwalletRecordMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.GgMemberRwalletRecordMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('gg_member_rwallet_record');
		$tMap->setPhpName('GgMemberRwalletRecord');
