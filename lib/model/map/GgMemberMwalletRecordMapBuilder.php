...
class GgMemberMwalletRecordMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.GgMemberMwalletRecordMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('gg_member_mwallet_record');
		$tMap->setPhpName('GgMemberMwalletRecord');
