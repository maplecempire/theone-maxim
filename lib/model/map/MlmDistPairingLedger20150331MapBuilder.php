...
class MlmDistPairingLedger20150331MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.MlmDistPairingLedger20150331MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mlm_dist_pairing_ledger_20150331');
		$tMap->setPhpName('MlmDistPairingLedger20150331');
