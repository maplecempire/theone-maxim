...
class MlmDistBankslipMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.MlmDistBankslipMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mlm_dist_bankslip');
		$tMap->setPhpName('MlmDistBankslip');
