...
class GgMemberTwalletTransferMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.GgMemberTwalletTransferMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('gg_member_twallet_transfer');
		$tMap->setPhpName('GgMemberTwalletTransfer');
