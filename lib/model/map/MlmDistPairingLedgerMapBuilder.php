...
class MlmDistPairingLedgerMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.MlmDistPairingLedgerMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mlm_dist_pairing_ledger');
		$tMap->setPhpName('MlmDistPairingLedger');
